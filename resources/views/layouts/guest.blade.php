...
<body class="antialiased bg-[#FDFBF7] text-gray-900 flex flex-col min-h-screen">
    ...
    <nav class="bg-[#9B663A] w-full px-6 py-2 flex items-center justify-between shadow-md sticky top-0 z-50">
        ...
        <div class="hidden md:flex flex-1 justify-center space-x-8 text-white font-medium text-sm md:text-base">
            ...
            <a href="https://donasipendidikan.com/" class="hover:text-[#F3E5D8] transition-colors">
                Home
            </a>

            <a href="https://ykip.org/id/" target="_blank" rel="noopener noreferrer" class="hover:text-[#F3E5D8] transition-colors">
                Visit Us
            </a>

            <a href="https://donasipendidikan.com/#about" class="hover:text-[#F3E5D8] transition-colors">
                About
            </a>
        </div>
                ...
                <div class="flex flex-col md:flex-row justify-center items-start gap-12 md:gap-20 w-full text-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="https://ykip.org/id/" target="_blank" rel="noopener noreferrer" class="text-gray-300">
                                info@ykip.org
                            </a>
                        </div>
                    </div>
        ...
        <div class="bg-[#9B663A] w-full py-4 px-6 text-sm">
            <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                ...
                <div class="flex justify-center md:justify-end gap-5">
                    <a href="https://www.instagram.com/ykip_bali/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-[#F3E5D8] transition-colors">
                    ...
                    <a href="https://www.facebook.com/YKIPBali" target="_blank" rel="noopener noreferrer" class="text-white hover:text-[#F3E5D8] transition-colors">
